...
class BaseFinancingSourceSchema(BaseModel):
    id: Optional[int] = Field(None, description="Unique financing source ID")
...
class AddFinancingSourceSchema(BaseFinancingSourceSchema):
...
class UpdateFinancingSourceSchema(BaseFinancingSourceSchema):
    pass


class DeleteFinancingSourceSchema(BaseModel):
    id: int
