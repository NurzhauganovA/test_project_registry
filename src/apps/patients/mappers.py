...
def map_patient_domain_to_db_entity(patient: PatientDomain) -> SQLAlchemyPatient:
    ...
    return SQLAlchemyPatient(
        ...
        social_status=patient.social_status if patient.social_status else None,
        marital_status=patient.marital_status if patient.marital_status else None,
        profile_status=patient.profile_status if patient.profile_status else None,
